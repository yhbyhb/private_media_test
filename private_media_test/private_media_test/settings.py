"""
Django settings for private_media_test project.
...
SECRET_KEY = 'nb1fn&x-kt1uw&&u*2q%24olt(o%*67)gwb=qz6@$45dn4=e=l'
...
ROOT_URLCONF = 'private_media_test.urls'
...
WSGI_APPLICATION = 'private_media_test.wsgi.application'
